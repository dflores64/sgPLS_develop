q2.pls10 <- function(object, mode = "regression", ncomp.max = object$ncomp){
  ...
  q2.pls.results <- list(q2 = q2, suggestion = suggestion, h.best = h.best, PRESS = PRESS, RSS = RSS, PRESSj = PRESSj, RSSj = RSSj)
